function runClassificationTstat(topDir, subNum, task1, task2, freqTarget)
...
file2bsaved = [task1 '_' task2 '_allChan_' num2str(freqTarget(1)) 'to' num2str(freqTarget(2)) '.mat'];
